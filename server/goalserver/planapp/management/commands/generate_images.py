    ...
    def handle(self, *args, **options):
        ...
        if "shopping" not in pic_list:
            shopping = Pic.objects.create(
                ...
                attr_description = "Shopping cart icons created by Freepik - Flaticon"
            )
            shopping.save()
            pic_count += 1
        ...
        if "search" not in pic_list:
            search = Pic.objects.create(
                ...
                attr_description = "Search icons created by Maxim Basinski Premium - Flaticon"
            )
            search.save()
            pic_count += 1
        if "song" not in pic_list:
            song = Pic.objects.create(
                ...
                attr_link = "https://www.flaticon.com/free-icons/google-play-music",
                attr_title = "google play music icons",
                attr_description = "Google play music icons created by Pixel perfect - Flaticon"
            )
            song.save()
            pic_count += 1
        if "star" not in pic_list:
            star = Pic.objects.create(
                ...
                attr_description = "Star icons created by Pixel perfect - Flaticon"
            )
            star.save()
            pic_count += 1
        ...
        if "dollar" not in pic_list:
            dollar = Pic.objects.create(
                ...
                attr_description = "Dollar symbol icons created by Good Ware - Flaticon"
            )
            dollar.save()
            pic_count += 1
        ...
        if "weight" not in pic_list:
            weight = Pic.objects.create(
                ...
                attr_description = "Fitness icons created by Smashicons - Flaticon"
            )
            weight.save()
            pic_count += 1
        ...
        if "hourglass" not in pic_list:
            hourglass = Pic.objects.create(
                ...
                attr_description = "Hourglass icons created by prettycons - Flaticon"
            )
            hourglass.save()
            pic_count += 1
        if "x" not in pic_list:
            x = Pic.objects.create(
                ...
                attr_description = "Close icons created by Pixel perfect - Flaticon"
            )
            x.save()
            pic_count += 1
