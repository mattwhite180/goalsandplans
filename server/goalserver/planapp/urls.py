...
urlpatterns = [
    ...
    path("task/<int:task_id>/delete-todo/", views.delete_task_todo, name="delete_task_todo"),
    path("task/<int:task_id>/delete-todolist/", views.delete_task_todolist, name="delete_task_todolist"),
