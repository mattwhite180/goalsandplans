...
urlpatterns = [
    ...
    path('goal/<int:goal_id>/edit/', views.edit_miniTodo, name='edit_minitodo'),
    path('minitodo/<int:mini_id>/edit/', views.edit_goal, name='edit_goal'),
    ...
    path('minitodo/<int:mini_id>/delete/', views.delete_miniTodo, name='delete_minitodo'),
