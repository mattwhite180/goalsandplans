...
urlpatterns = [
    ...
    path(
        "plan/<int:plan_id>/newtask",
        views.plan_create_task,
    ...
    path(
        "task/<int:task_id>/remove_todo/",
        views.task_remove_todo,
        name="remove_todo"
    ),
    path("quick_task/", views.quick_task, name="quick_task"),
    path("todolist/<int:todo_id>/", views.todolist, name="todolist"),
    path(
        "todolist/<int:todo_id>/edit/",
        views.edit_todolist,
        name="edit_todolist"
    ),
    path(
        "todolist/<int:todo_id>/delete/",
        views.delete_todolist,
